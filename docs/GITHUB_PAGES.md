...
**local-volatility**, styled identically to the sister projects
...
4. After the first build (about a minute) the site is served at
   `https://ashjha0.github.io/local-volatility/`.
...
- Everything else under `docs/` is reachable by its path, e.g.
  `https://ashjha0.github.io/local-volatility/ARCHITECTURE.md` (served raw).
